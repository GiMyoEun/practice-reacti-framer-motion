...
export default function WelcomePage() {
    const { scrollY } = useScroll(); // scrollYProgress : 스크롤 얼마나 내렸는지 상대적 값, scrollY 절대적 값
    const yCity = useTransform(scrollY, [0, 200], [0, -100]);
    const opacityCity = useTransform(scrollY, [0, 200, 300, 500], [1, 0.5, 0.5, 0]); // 사용자가 스크롤을 내린만큼에 해당하는 픽셀 값, 중단점으로 구성된 배열, 중단점들과 중단점들 사이에 있는 값들이 변환되어야 하는 값의 배열
